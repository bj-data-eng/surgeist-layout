# P01-I04-S01-C04 Contextual And Calc-Size Dispatch
Status: complete
Cycle ID: `P01/I04/S01/C04`
...
at SHA-256 `49ede2ba2672a91f99ba193651dbb1350ede7b80`, commit `5d33f3a4ab694f12985d713f7dbc74b251d55fb6`, sections `FRI-04.4 D-03`, `D-05`, `D-06`, the error front door in `FRI-04.5`, the calc-size rows of `FRI-04.6`, the capability, calc-size, flex, and algorithm evidence in `FRI-04.8`, the production algorithm rows of `FRI-04.9`, and acceptance items 6, 8, 9, and 14.

Reviewed sequence: `plans/P01-layout/sequences/P01-I04-S01-property-specific-sizing-values.md`
at SHA-256 `2e006d30b0250c526e10bba13a37e58e111ff60791b34f8d7c2e4d0e527db13f`, commit `0a666f8f698703cd7979194a7f75f834e4c9b522`, entry `P01/I04/S01/C04`.
...
## 4 Tasks
### 4.1 `P01/I04/S01/C04/T01` Typed Capability And Calc-Size Dispatch
...
### 4.2 `P01/I04/S01/C04/T02` Leaf, Block, Root, And Positioned Consumption
...
just verify
```
**Dependency:** `T01` supplies the reviewed typed dispatcher.
**Intended commit:** `fix(layout): dispatch leaf block and positioned sizing states`.

### 4.3 `P01/I04/S01/C04/T03` Flex Property And Basis Semantics
...
just verify
```
**Dependency:** `T01` is task-clean; T02 establishes shared non-flex use.
**Intended commit:** `fix(layout): distinguish flex sizing and content bases`.

### 4.4 `P01/I04/S01/C04/T04` Grid And Grid-Lanes Dispatch Closure
...
just verify
```
**Dependency:** `T01` through `T03` are task-clean.
