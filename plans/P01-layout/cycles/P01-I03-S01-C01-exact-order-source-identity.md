# P01-I03-S01-C01 Exact Order And Source Identity

Status: complete
Cycle ID: `P01/I03/S01/C01`
...
commit `0a666f8f698703cd7979194a7f75f834e4c9b522`, sections `FRI-03.1`,
...
### 3.1 `P01/I03/S01/C01/T01` - Public Order And Source Types
...
until T02 so this task is independently buildable; it is not a compatibility
commitment.
...
### 3.2 `P01/I03/S01/C01/T02` - Rename Source Identity Carriers
...
### 3.3 `P01/I03/S01/C01/T03` - Stable Permutation And Absence Gates
...
Cycle acceptance: T01 through T03 are implemented, reviewed, and
