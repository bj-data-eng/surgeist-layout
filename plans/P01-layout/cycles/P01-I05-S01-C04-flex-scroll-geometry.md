# P01-I05-S01-C04 Flex Scroll Geometry And Main-Axis Semantics
Status: complete
Cycle ID: `P01/I05/S01/C04`
...
commit `07ed42c2a832a7c6fccb11b5d77953fa9c159917`, entry `P01/I05/S01/C04`.
...
`src/scroll.rs`, and the affected flex/root/cache/contract/static tests. T04 also
...
### 4.1 `P01/I05/S01/C04/T01` Canonical Flex Box And Retained Child Output
...
### 4.2 `P01/I05/S01/C04/T02` Shared Flex Contribution And Content Extent
...
**Dependency:** T01 retains exact child geometry and establishes the canonical
container source.

**Intended commit:** `fix(layout): unify flex scroll contributions`.

### 4.3 `P01/I05/S01/C04/T03` Flex Origins And Content-Distribution Subjects
**Files:** `src/flex.rs`, narrowly required `src/scroll.rs`, and focused flex and
root tests.
...
**Dependency:** T02 supplies complete pass-local placement and overflow.

**Intended commit:** `feat(layout): derive flex scroll origins and subjects`.

### 4.4 `P01/I05/S01/C04/T04` Monotone Flex Auto Settlement
...
**Dependency:** T03 supplies every origin and alignment-subject fact consumed
by the pass-local auto observation.

**Reconciliation gate:** The initial T04 span ending at
...
reconciliation span, reruns every T04 acceptance command, and a fresh task
reviewer reviews the complete ordered T04 range before T05 may start. T01 through
T03 remain task-clean and require no re-review.

**Intended commit:** `feat(layout): settle flex auto scrollbars`.

### 4.5 `P01/I05/S01/C04/T05` Flex Rounding Cache And Legacy Closure
...
T01 through T04. Prove the temporary output field is synchronized only by
...
**Dependency:** T04 completes the flex source facts rebuilt by rounding.
