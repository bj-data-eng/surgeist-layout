# P01-I06-S01-C05 Rectangular Float And BFC Geometry

Status: complete

Cycle ID: `P01/I06/S01/C05`
...
commit `49ede2ba2672a91f99ba193651dbb1350ede7b80`, decisions `D-13` and
...
commit `0a666f8f698703cd7979194a7f75f834e4c9b522`, entry `P01/I06/S01/C05`.
...
### 4.1 `P01/I06/S01/C05/T01` Make Rectangular Exclusions And Float Placement Flow-Relative
...
### 4.2 `P01/I06/S01/C05/T02` Drive Unified Inline Lines And Clear From Rectangular Bands
...
`fri06_c04_line_clear_`, and `fri06_c04_line_alignment_` first. At the exact T02
...
### 4.3 `P01/I06/S01/C05/T03` Close The Current BFC Avoidance And Sizing Predicate
...
`fri06_c04_bfc_size_`, and `fri06_c04_bfc_nested_` first. At exact T03 base,
...
### 4.4 `P01/I06/S01/C05/T04` Close Float Size, Scroll, Cache, Rounding, And Invalidation
...
RED only for genuine missing behavior at exact T04 base; record already-correct
...
**Dependency:** T03 is task-clean. **Intended commit:**
