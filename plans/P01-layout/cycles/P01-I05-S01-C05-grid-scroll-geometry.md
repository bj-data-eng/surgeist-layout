# P01-I05-S01-C05 Grid Family Scroll Geometry
Status: complete
Cycle ID: `P01/I05/S01/C05`
...
## 4 Tasks
### 4.1 `P01/I05/S01/C05/T01` Grid Overflow Sizing Decisions
...
### 4.2 `P01/I05/S01/C05/T02` Grid Child Geometry And Contributions
...
**Dependency:** T01 supplies the one flow-aware used-overflow decision.

**Intended commit:** `fix(layout): retain grid child scroll contributions`.

### 4.3 `P01/I05/S01/C05/T03` Ordinary Grid Reservation Origins And Output
...
**Dependency:** T02 supplies retained child sources and complete contribution.

**Intended commit:** `feat(layout): emit ordinary grid scroll geometry`.

### 4.4 `P01/I05/S01/C05/T04` Subgrid And Grid-Lanes Canonical Output
...
**Dependency:** T03 establishes the ordinary grid container integration.

**Intended commit:** `feat(layout): emit subgrid and lanes scroll geometry`.

### 4.5 `P01/I05/S01/C05/T05` Grid Rounding Cache And Legacy Closure
...
**Dependency:** T04 migrates the last grid-family producers.
