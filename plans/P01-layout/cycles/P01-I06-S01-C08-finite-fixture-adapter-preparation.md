# P01-I06-S01-C08 Finite Fixture Adapter Preparation

Status: complete

Cycle ID: `P01/I06/S01/C08`
...
commit `49ede2ba2672a91f99ba193651dbb1350ede7b80`, sections
...
P01/I06/S01/C06 and the post-C05 containment window are published and remotely
...
`/private/tmp/surgeist-layout-FRI06-T04-worker-01-red.G14eje/worktree`
and `refs/surgeist/FRI06-T04-worker-01/red` are absent. C07 creates fresh
...
fixes; only this older test still substitutes `drop(first)`. T04 corrects that
...
permitted is the exact T04 lifecycle test in
...
### 4.1 `P01/I06/S01/C08/T01` Compare Control And Fragment Output Exactly
...
### 4.2 `P01/I06/S01/C08/T02` Lower Finite Shaped And Atomic Fixture Inputs
...
**Dependency:** T01's final-fragment expectation model.
...
### 4.3 `P01/I06/S01/C08/T03` Lower Bottom Alignment And Finite Shape Bands
...
**Dependency:** T02's complete finite fixture tree.
...
### 4.4 `P01/I06/S01/C08/T04` Align Lease Lifecycle Test With Explicit Release
...
**Dependency:** T01-T03 task-clean, initial holistic review clean, and the
...
All four task ranges must retain clean reviews. T04 changes only the stale
...
CARGO_NET_OFFLINE=true just verify-generator
cargo fmt --check
git diff --check b608fe1864b3bb34b4ef293055cc9d1015ec4fb6595295c7bd8f123d675c6b52..HEAD
git diff --quiet -G'(^|[^.[:alnum:]_])(allow|expect)[[:space:]]*\(' 0a666f8f698703cd7979194a7f75f834e4c9b522..HEAD -- '*.rs'
test "$(git diff --name-only --no-renames 6e3772f509b919ec9a9d027d8298600ed98ee531..HEAD)" = $'plans/P01-layout/cycles/P01-I06-S01-C08-finite-fixture-adapter-preparation.md\nplans/P01-layout/sequences/P01-I06-S01-inline-formatting-floats-bfcs.md\ntests/bin/surgeist-layout-generate/generator.rs\ntests/layout/browser_parity/support.rs'
test ! -e /private/tmp/surgeist-layout-FRI06-T04-worker-01-red.G14eje/worktree
...
reconciled C06 plan path, the exact T04 generator lifecycle test file, and
