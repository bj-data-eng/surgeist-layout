# P01-I06-S01-C04 Mixed Atomic And Control Line Completion

Status: complete

Cycle ID: `P01/I06/S01/C04`
...
commit `49ede2ba2672a91f99ba193651dbb1350ede7b80`, section `FRI-06.4`
...
commit `0a666f8f698703cd7979194a7f75f834e4c9b522`, entry `P01/I06/S01/C04`.
...
### 4.1 `P01/I06/S01/C04/T01` Compose Text And Atomic Boxes Through One Break And Bidi Source
...
`fri06_c03_atomic_break_`, and `fri06_c03_mixed_bidi_` first. At exact T01 base
...
runs no longer do. T01 does not add an opaque control unit or invent partial
control break/bidi semantics. T02 removes this final control-specific gate.
...
### 4.2 `P01/I06/S01/C04/T02` Integrate Controls, Empty Struts, And Logical Clear
...
`fri06_c03_strut_`, and `fri06_c03_clear_` first. At exact T02 base, mixed
...
The final search must return no matches. **Dependency:** T01 is task-clean.
**Intended commit:**
`feat(layout): integrate inline controls and logical clear`.

### 4.3 `P01/I06/S01/C04/T03` Complete Atomic And Control Line Metrics And Percentage Basis
...
`fri06_c03_top_bottom_`, and `fri06_c03_percentage_` first. At exact T03 base,
...
**Dependency:** T02 is task-clean. **Intended commit:**
`fix(layout): complete atomic inline line metrics`.

### 4.4 `P01/I06/S01/C04/T04` Close Fixed-Size, Projection, And Publication Lifecycle
...
`fri06_c03_projection_`, and `fri06_c03_lifecycle_` first. At exact T04 base,
...
Both searches must return no matches. **Dependency:** T03 is task-clean.
